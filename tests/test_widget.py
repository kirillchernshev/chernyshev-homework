...
@pytest.mark.parametrize("input_data, expected", [
    ("Счет 12345678901234567890", f"Счет {get_mask_account('12345678901234567890')}"),
    ("Visa Platinum 1234567812345678", f"Visa Platinum {get_mask_card_number('1234567812345678')}"),
    ("MasterCard 1111222233334444", f"MasterCard {get_mask_card_number('1111222233334444')}"),
    ("Maestro 1234567812345678", f"Maestro {get_mask_card_number('1234567812345678')}"),
    ("счет 12345678901234567890", f"счет {get_mask_account('12345678901234567890')}"),  # lowercase
])
